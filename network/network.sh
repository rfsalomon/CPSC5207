...
function createOrgs() {
  ...
  if [ "$CRYPTO" == "cfssl" ]; then
    ...
    peer_cert peer peer0.org1.cpsc5207.ca org1
    peer_cert admin Admin@org1.cpsc5207.ca org1

    infoln "Creating Org2 Identities"
    #function_name cert-type   CN   org
    peer_cert peer peer0.org2.cpsc5207.ca org2
    peer_cert admin Admin@org2.cpsc5207.ca org2

    infoln "Creating Orderer Org Identities"
    #function_name cert-type   CN   
    orderer_cert orderer orderer.cpsc5207.ca
    orderer_cert admin Admin@cpsc5207.ca
...
function networkDown() {
  ...
  if [ "$MODE" != "restart" ]; then
    ...
    ${CONTAINER_CLI} volume rm docker_orderer.cpsc5207.ca docker_peer0.org1.cpsc5207.ca docker_peer0.org2.cpsc5207.ca
